...
if ($moduleRight >= "R"):
	...
	$arTabs = [
		[
			'tab' => [
				"DIV" => "Settings",
				"TAB" => GetMessage("CATALOG_CREATOR_TAB_SETTINGS"),
				"ICON" => $moduleID . "_settings",
				"TITLE" => GetMessage("CATALOG_CREATOR_TAB_SETTINGS_TITLE"),
            ],
			'options' => [
				["types_product",         GetMessage("CATALOG_CREATOR_TOTAL_PRODUCTS"), ["text", 24], 'default' => '1000'],
				["types_price",           GetMessage("CATALOG_CREATOR_TOTAL_PRICES"), ["text", 24], 'default' => '10'],
				["types_store",           GetMessage("CATALOG_CREATOR_TOTAL_STORES"), ["text", 24], 'default' => '100'],
				...
				["preview_picture_width", GetMessage("CATALOG_CREATOR_OPT_PREVIEW_PICTURE_WIDTH"), ["text", 24], 'default' => '300'],
				["preview_picture_height", GetMessage("CATALOG_CREATOR_OPT_PREVIEW_PICTURE_HEIGHT"), ["text", 24], 'default' => '200'],
				["detail_picture_width", GetMessage("CATALOG_CREATOR_OPT_DETAIL_PICTURE_WIDTH"), ["text", 24], 'default' => '800'],
				["detail_picture_height", GetMessage("CATALOG_CREATOR_OPT_DETAIL_PICTURE_HEIGHT"), ["text", 24], 'default' => '600'],
				["catalog_price_max_decimals", GetMessage("CATALOG_CREATOR_OPT_CATALOG_PRICE_MAX_DECIMALS"), ["text", 24], 'default' => '2'],
				["catalog_price_min", GetMessage("CATALOG_CREATOR_OPT_CATALOG_PRICE_MIN"), ["text", 24], 'default' => '0'],
				["catalog_price_max", GetMessage("CATALOG_CREATOR_OPT_CATALOG_PRICE_MAX"), ["text", 24], 'default' => '10000'],
				["catalog_weight_min", GetMessage("CATALOG_CREATOR_OPT_CATALOG_WEIGHT_MIN"), ["text", 24], 'default' => '0'],
				["catalog_weight_max", GetMessage("CATALOG_CREATOR_OPT_CATALOG_WEIGHT_MAX"), ["text", 24], 'default' => '100'],
				["catalog_width_min", GetMessage("CATALOG_CREATOR_OPT_CATALOG_WIDTH_MIN"), ["text", 24], 'default' => '0'],
				["catalog_width_max", GetMessage("CATALOG_CREATOR_OPT_CATALOG_WIDTH_MAX"), ["text", 24], 'default' => '100'],
				["catalog_length_min", GetMessage("CATALOG_CREATOR_OPT_CATALOG_LENGTH_MIN"), ["text", 24], 'default' => '0'],
				["catalog_length_max", GetMessage("CATALOG_CREATOR_OPT_CATALOG_LENGTH_MAX"), ["text", 24], 'default' => '100'],
				["catalog_height_min", GetMessage("CATALOG_CREATOR_OPT_CATALOG_HEIGHT_MIN"), ["text", 24], 'default' => '0'],
				["catalog_height_max", GetMessage("CATALOG_CREATOR_OPT_CATALOG_HEIGHT_MAX"), ["text", 24], 'default' => '100'],
				["catalog_quantity_min", GetMessage("CATALOG_CREATOR_OPT_CATALOG_QUANTITY_MIN"), ["text", 24], 'default' => '0'],
				["catalog_quantity_max", GetMessage("CATALOG_CREATOR_OPT_CATALOG_QUANTITY_MAX"), ["text", 24], 'default' => '100'],
				["property_multiple_count", GetMessage("CATALOG_CREATOR_OPT_PROPERTY_MULTIPLE_COUNT"), ["text", 24], 'default' => '3'],
				["property_string_length", GetMessage("CATALOG_CREATOR_OPT_PROPERTY_STRING_LENGTH"), ["text", 24], 'default' => '10'],
				["property_text_length", GetMessage("CATALOG_CREATOR_OPT_PROPERTY_TEXT_LENGTH"), ["text", 24], 'default' => '600'],
            ]
        ],
		[
			'tab' => [
